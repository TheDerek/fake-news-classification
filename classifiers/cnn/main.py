...
def cnn_model_fn(features, labels, mode):
    ...
    conv1 = tf.layers.conv2d(
        ...
        kernel_size=[5, cnn.TEXT_IMAGE_WIDTH],
        padding="same",
    ...
    # If we are trying to predict using the features rather than training with them
    # return the predictions, otherwise train the model
